...
--
-- Host: localhost
-- Generation Time: Oct 08, 2015 at 08:16 PM
...
INSERT INTO `aauth_users` (`id`, `fullname`, `email`, `pass`, `name`, `residence_id`, `country_id`, `phone`, `gender_id`, `picture_id`, `banned`, `last_login`, `last_activity`, `last_login_attempt`, `forgot_exp`, `remember_time`, `remember_exp`, `verification_code`, `totp_secret`, `ip_address`, `login_attempts`, `is_suspended`, `is_deleted`, `group_id`) VALUES
(1, 'Onuwa Nnachi Isaac', 'matrix4u2002@gmail.com', '$2y$10$iiK.7yJti6i70rQaV0JvN.nkoEwLjygXbrG9gQ/fOyJyaznp/TAGO', 'matrix4u', 11, 0, '08062457326', 1, NULL, 0, '2015-10-08 17:54:09', '2015-10-08 17:54:09', '2015-10-08 17:00:00', NULL, NULL, NULL, NULL, NULL, '127.0.0.1', NULL, 0, 0, 0),
(2, 'Anya Chima', 'chimaeyes@gmail.com', '$2y$10$FJEi200/5h8oC7VqeUoQqeO1o.wm5vAFDJOj/mtj5mJL6tA6Xu3qy', 'chima', 0, 0, '08062457326', 0, NULL, 0, '2015-10-08 19:50:27', '2015-10-08 19:50:27', '2015-10-08 19:00:00', NULL, NULL, NULL, '', NULL, '127.0.0.1', NULL, 0, 0, 0);
...
(1, 'Nigerian tribunal issues arrest warrant for Senate president', 'news-1442765387saraki.JPG', 'news', 1, 1442765387),
(2, 'Ebonyi, Ekiti, Imo, Ogun, Oyo get FG’s bail-out funds', 'news-1442765433bail.jpg', 'news', 1, 1442765433),
(20, '<p>My Uploads</p>', 'cam-1442781384Screenshotfrom2015-09-0413:39:07.png', 'cam-tales', 2, 1442781384),
(21, 'Edo can feed Nigeria with rice - Oshiomhole', 'news-1442814962edo.jpg', 'news', 1, 1442814962),
(24, '', 'cam-1442816358IMG_20150807_143859.jpg', 'cam-tales', 2, 1442816358),
(25, '', 'cam-1442816359IMG_20150807_143837.jpg', 'cam-tales', 2, 1442816359),
(26, '', 'cam-1442816359IMG_20150807_143828.jpg', 'cam-tales', 2, 1442816359);
...
ALTER TABLE `aauth_perm_to_group`
  ...
  ADD KEY `fk_aauth_perm_to_group_aauth_groups1_idx` (`group_id`);
...
ALTER TABLE `aauth_perm_to_user`
  ...
  ADD KEY `fk_aauth_perm_to_user_aauth_users1_idx` (`user_id`);

--
-- Indexes for table `aauth_pms`
--
ALTER TABLE `aauth_pms`
  ADD KEY `full_index` (`sender_id`,`receiver_id`,`read`),
  ADD KEY `fk_aauth_pms_aauth_users2_idx` (`receiver_id`);
...
ALTER TABLE `aauth_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_aauth_users_nowayo_gender_idx` (`gender_id`),
  ADD KEY `fk_aauth_users_nowayo_state1_idx` (`residence_id`),
  ADD KEY `fk_aauth_users_aauth_groups1_idx` (`group_id`);
...
ALTER TABLE `nowayo_news`
  ...
  ADD KEY `fk_nowayo_news_nowayo_state1_idx` (`category`),
  ADD KEY `fk_nowayo_news_aauth_users1_idx` (`news_user_fk`);
...
ALTER TABLE `nowayo_uploads`
  ...
  ADD KEY `fk_nowayo_uploads_aauth_users1_idx` (`user_id`);
