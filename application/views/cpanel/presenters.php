  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" data-toggle="modal" data-target="#removePresenter" class="btn btn-danger">Remove Moderator</button>
...
<div class="modal fade" id="removePresenter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Remove Presenter - <?php echo $value->fullname;?>?</h4>
      </div>
      <div class="modal-body">
     <div class="modal-body">
     Do you Want To Remove Presenter <?php echo $value->fullname;?>?
      </div>
      <div class="modal-footer">
