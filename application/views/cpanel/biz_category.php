...
<h3>Available Category</h2>
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form method="POST" action="<?php echo base_url('cp/biz_category/delete_cat');?>">
                                     ...
                                     for($index = 0; $index < count($business); $index++) {
                                        ...
                                        <td align="center"><input type="checkbox" name="selector" id="selector[]" value="<?php echo $business[$index]['id'];?>"></td>
                                           ...
                                           <td></td>
                                            ...
                                            <input type="hidden" name="cat_name" value="<?php echo $business[$index]['name'];?>">
                                             </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
          ...
          <button type="submit" class="btn btn-default" <?=isset($business) ? '' : 'disabled'?> name="delete_cat"/><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</div>
            </div>
                            </div>
