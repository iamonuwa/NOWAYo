...
<?php echo form_open_multipart('blog/create');?>
    ...
    <input type="text" name="title"  class="grid grid-1" required placeholder="News Headline">
...
<!--
   ...
   -->
    ...
    <div class="form-group ">
    News Category <select name = "category">
    ...
    <textarea  name="content" id="elm1" cols="30" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false"  placeholder="Type News Here">
    </textarea required>
    </span>
	  </div>
    <input type="submit" name="save"  class="wpcf7-form-control wpcf7-submit" value="Create News Content">
